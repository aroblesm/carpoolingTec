$(document).ready(function () {
    ...
    $("#editBtn").click(function () {
        ...
        $("#profileH3").html("<i class=\"fa fa-pencil-square-o\"></i> Editar perfil");
        $("#fullNameField").hide();
        $("#nameField").show();
    ...
    $("#saveBtn").click(function () {
        ...
        $("#save-cancel-btn-group").hide();
        $("#editBtn").show();
        $("#profileH3").html("<i class=\"fa fa-user-circle-o\"></i> Perfil");
        $("#passwordField").hide();
        $("#nameField").hide();
        $("#fullNameField").show();
        $("#changePassLink").show();
    ...
    $("#changePassLink").click(function () {
        ...
        $("#profileH3").html("<i class=\"fa fa-lock\"></i> Cambiar contraseña");
        $("#passwordField").show();
